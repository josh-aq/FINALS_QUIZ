            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                <div class="text-center">
                  <img class="profile-user-img img-fluid img-circle" src="../../images/romel.jpg" alt="User profile picture">
                </div>
                <!DOCTYPE html>

</body>
</html>
                <h3 class="profile-username text-center">Romel Tolentino</h3>

                <p class="text-muted text-center"> Information Technology Assistant</p>
            </div>
            <!-- /.card -->
...
<hr>
                ...
                <p class="text-muted">Macabebe, Pampanga</p>
                ...
                <p class="text-muted">
                  ...
                  <span class="tag tag-success">romeljosh@gmail.com<br> </span>
                </p>
                <hr>
            ...
            <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch">
              <div class="card bg-light">
                ...
                <div class="card-body pt-0">
                  <div class="row">
                    <div class="col-7">
                      <h2 class="lead"><b>Micah Aquino</b></h2>
